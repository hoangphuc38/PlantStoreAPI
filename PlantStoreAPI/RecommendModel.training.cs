...
namespace PlantStoreAPI
{
    ...
    {
        public const string RetrainConnectionString = @"Data Source=DESKTOP-9GODJ37\MSSQLSERVER2019;Initial Catalog=PlantStoreAPI;Integrated Security=True";
        public const string RetrainCommandString = @"SELECT CAST([CustomerID] as REAL), CAST([ProductID] as REAL), CAST([Rating] as REAL) FROM [dbo].[DatasetUserAndFeedback]";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"ProductID",inputColumnName:@"ProductID",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"Rating",MatrixColumnIndexColumnName=@"CustomerID",MatrixRowIndexColumnName=@"ProductID",ApproximationRank=13,LearningRate=0.187410768670151,NumberOfIterations=59,Quiet=true}))      
